...
var Valdate = (function () {
    function Valdate() {
    }
    Valdate.toTop = function (posX, posY, data) {
        posX -= 1;
    ...
    Valdate.toRight = function (posX, posY, data) {
        posY += 1;
    ...
    Valdate.toBottom = function (posX, posY, data) {
        posX += 1;
    ...
    Valdate.toLeft = function (posX, posY, data) {
        posY -= 1;
